  ...
  return ( 
    <div className={HomeCSS.page}>
      <div className={`${HomeCSS.gridContainer} ${HomeCSS.center}`}>
        ...
        <img src={hikerGreenSnowy} alt="Backpackers heading towards a snowy mountain from a green meadow"/>
      </div>
      ...
      <div className={HomeCSS.gridContainer}>
        ...
        <img src={gearAll} alt="A backpacker's gear neatly organized on a wooden floor"/>
      </div>
