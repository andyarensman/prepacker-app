...
const Navbar = () => {
  ...
  return (
    <header className={NavbarCSS.header}>
      <div className={NavbarCSS.container}>
        <Link to="/">
          <img
            src={prePackerLogo}
            alt="PrePacker"
            className={NavbarCSS.titleLogo}
          ></img>
        </Link>
        <nav className={NavbarCSS.desktopNav}>
          •<Link to="/gear-closet">Gear Closet</Link>•
        ...
        {user && (
          <div className={NavbarCSS.loggedInHub}>
            ...
            <button onClick={handleClick} className={NavbarCSS.logoutBtn}>
              Logout&nbsp;
          ...
          <div className={NavbarCSS.mobileLogin}>
            {!user && (
              ...
              >
                Login&nbsp;
                <span
                  className={`${NavbarCSS.symbols} material-symbols-outlined`}
                >
                  login
                </span>
              </span>
          ...
          {user && (
            <>
              <nav className={NavbarCSS.mobileNav}>
                <Link
                  to="/gear-closet"
                  onClick={() => setHiddenHamburger(true)}
                >
                  Gear Closet
                </Link>
      ...
      <LoginModal hiddenLogin={hiddenLogin} setHiddenLogin={setHiddenLogin} />
      <SignupModal
