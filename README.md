...
Coding Note: Make sure you change the environment variable on the frontend to the correct route before trying to run the app locally or before building the app. Add the `_redirects` file to the build folder before deploying. I may need to change the version of Node I'm using when working on this project (v14).
